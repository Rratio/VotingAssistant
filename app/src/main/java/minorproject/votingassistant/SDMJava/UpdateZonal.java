...
public class UpdateZonal extends Fragment implements TextWatcher, Spinner.OnItemSelectedListener{
    ...
    public String UPDATE_URL="http://bond-vehicles.000webhostapp.com/Voting/updateapi.php?z_id=";
    public ZonalAdapter adapter;
    private boolean nv, fv, Success,Update;
    ZonalModel model;
    ProgressDialog progressDialog;
    String id, name, sdmID, Msg,Message, ZonalName,ZonalNumber;
    Spinner spinner;
    int ID =0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_update_zonal, container, false);
        ...
        spinner= (Spinner) view.findViewById(R.id.zonalupdatearea);
        ...
        zonalname= (EditText) view.findViewById(R.id.zonalname);
        zonalnumber= (EditText) view.findViewById(R.id.zonalnumber);
        zonalsubmit= (Button) view.findViewById(R.id.updatezonal);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, UPDATE_URL+ID, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (Update) {
                        ZonalName = jsonObject.getString("zonal_name");
                        ZonalNumber = jsonObject.getString("zonal_number");
                        Log.e("NAME",":::::"+ZonalName);
                        zonalname.setText(ZonalName);
                        zonalnumber.setText(ZonalNumber);
                    }
                    else{
