...
public class ZonalSdmWise extends Fragment {

    public String DATA_URL = "http://bond-vehicles.000webhostapp.com/Voting/listapi.php?sdm_id=";
    Fragment fragment;
    public ZonalPerAdapter adapter;
    ProgressDialog progressDialog;
    ListView ZonalSdmlisting;
    String sdmID;
    SharedPreferences sharedPreferences;
    public ArrayList<ZonalPerModel> sampel = new ArrayList<ZonalPerModel>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_zonal_sdm_wise, container, false);
        ZonalSdmlisting = (ListView) view.findViewById(R.id.zonalsdmper);

        adapter = new ZonalPerAdapter(getActivity(), sampel);
        ZonalSdmlisting.setAdapter(adapter);
                        ...
                        try {
                            ...
                            if(jArray.length()>0) {
                                ...
                                for (int i = 0; i < jArray.length(); i++) {
                                    ...
                                    ZonalPerModel ji = new ZonalPerModel();
