...
public class BoothSdmWise extends Fragment {

    public String DATA_URL = "http://bond-vehicles.000webhostapp.com/Voting/listapi.php?getlistbooth=";
    Fragment fragment;
    public BoothperAdapter adapter;
    ProgressDialog progressDialog;
    ListView BoothListing;
    String sdmID;
    SharedPreferences sharedPreferences;
    public ArrayList<BoothperModel> sampel = new ArrayList<BoothperModel>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_booth_sdm_wise, container, false);
        BoothListing = (ListView) view.findViewById(R.id.BoothSdmper);

        adapter = new BoothperAdapter(getActivity(), sampel);
                        ...
                        try {
                            ...
                            if(jArray.length()>0) {
                                ...
                                for (int i = 0; i < jArray.length(); i++) {
                                    ...
                                    BoothperModel ji = new BoothperModel();
                                    ...
                                    Log.e("boothpercentage",":::::"+json_data.getString("percentage"));
