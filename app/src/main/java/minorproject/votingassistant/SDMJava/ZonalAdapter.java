...
public class ZonalAdapter extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<ZonalModel> register;

    public ZonalAdapter(Activity activity, List<ZonalModel> bookItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ZonalModel m = register.get(position);
        // title
