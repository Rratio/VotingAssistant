...
public class ZonalDmAdapter extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<ZonalDmmodel> register;

    public ZonalDmAdapter(Activity activity, List<ZonalDmmodel> bookItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // TextView zonalnumber= (TextView) convertView.findViewById(R.id.Zonalpercentage);
        ...
        final ZonalDmmodel m = register.get(position);
        // title
