...
public class SdmDmAdapter extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<SdmDmmodel> register;

    public SdmDmAdapter(Activity activity, List<SdmDmmodel> bookItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final SdmDmmodel m = register.get(position);
        // title
