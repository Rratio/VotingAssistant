...
public class SDMList extends Fragment {


    public String DATA_URL = "http://bond-vehicles.000webhostapp.com/Voting/listapi.php?dm_id=";
    Fragment fragment;
    public SDMListAdapter adapter;
    ProgressDialog progressDialog;
    ListView SDMList;
    String dmID;
    SharedPreferences sharedPreferences;
    public ArrayList<SDMListModel> sampel = new ArrayList<SDMListModel>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sdmlist, container, false);
        SDMList = (ListView) view.findViewById(R.id.SDMList);

        adapter = new SDMListAdapter(getActivity(), sampel);
