...
import minorproject.votingassistant.DMActivity;
...
public class SDMAdd extends Fragment implements TextWatcher,Spinner.OnItemSelectedListener{

    private Spinner area;
    private EditText SDMname, SDMnumber;
    private Button addSDM;
    Fragment fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_sdmadd, container, false);
...
//        Toast.makeText(getActivity(),"ID------"+id,Toast.LENGTH_LONG).show();
            ...
            SDMname = (EditText) view.findViewById(R.id.sdmname);
            SDMnumber = (EditText) view.findViewById(R.id.sdmnumber);
            addSDM = (Button) view.findViewById(R.id.addSDM);
        ...
        download_Item();
            ...
            addSDM.setOnClickListener(new View.OnClickListener() {
                @Override
...
//                                .commit();
    ...
    public void afterTextChanged(Editable s) {
        ...
        if(s == SDMnumber.getEditableText()){
            ...
            if(num==false){
                addSDM.setBackground(this.getResources().getDrawable(R.drawable.invalidbutton));
            }
            else {
                addSDM.setBackground(this.getResources().getDrawable(R.drawable.validbutton));
