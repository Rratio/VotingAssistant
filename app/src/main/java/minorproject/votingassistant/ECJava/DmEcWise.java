...
public class DmEcWise extends Fragment {

    public String DATA_URL = "http://bond-vehicles.000webhostapp.com/Voting/listapi.php?dm=true";
    Fragment fragment;
    public DmEcAdapter adapter;
    ProgressDialog progressDialog;
    ListView DMList;
    public ArrayList<DmEcmodel> sampel = new ArrayList<DmEcmodel>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dm_ec_wise2, container, false);
        DMList = (ListView) view.findViewById(R.id.DmEcList);

        adapter = new DmEcAdapter(getActivity(), sampel);
