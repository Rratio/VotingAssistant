...
public class DMUpdate extends Fragment implements TextWatcher, AdapterView.OnItemSelectedListener {

    private Spinner district;
    private EditText DMname, DMnumber;
    private Button updateDM;
    ...
    public String UPDATE_URL="http://bond-vehicles.000webhostapp.com/Voting/updateapi.php?district_id=";
    private String Msg, Message, DmName,DmNumber;
    Fragment fragment;
    public DmAdapter adapter;
     boolean nv, fv, Success, Update;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dmupdate, container, false);
...
//        Toast.makeText(getActivity(),"Name------"+name,Toast.LENGTH_LONG).show();
        ...
        updateDM = (Button) view.findViewById(R.id.updateDM);
...
//       SPINNER VALUES
        ...
        updateDM.setOnClickListener(new View.OnClickListener() {
            @Override
...
//
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (s == DMnumber.getEditableText()) {
            ...
            if (!num) {
                updateDM.setBackground(this.getResources().getDrawable(R.drawable.invalidbutton));
            } else {
                updateDM.setBackground(this.getResources().getDrawable(R.drawable.validbutton));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, UPDATE_URL+ID, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (Update) {
                        DmName = jsonObject.getString("dm_name");
                        DmNumber = jsonObject.getString("dm_number");
                        Log.e("NAME",":::::"+DmName);
                        DMname.setText(DmName);
                        DMnumber.setText(DmNumber);
                    }
                    else{
