...
public class ECHomeScreen extends Fragment {

    private RecyclerView recyclerView;
    private DMDataAdapter adapter;
...
//
        ...
        View view = inflater.inflate(R.layout.fragment_dmhome_screen, container, false);
        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_view);
        logout = (MenuItem) view.findViewById(R.id.logout);

        albumList = new ArrayList<>();
        adapter = new DMDataAdapter(getActivity(), albumList);
...
//        });
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("ECHomeScreen");
    }
...
//    ON LOGOUT MENU SELECTION
    ...
    private void prepareAlbums() {
        ...
        DMData a = new DMData("Add DM", covers[0]);
        albumList.add(a);

        a = new DMData("Update DM", covers[1]);
        albumList.add(a);

        a = new DMData("Check Voting Status", covers[2]);
        albumList.add(a);

        a = new DMData("DM List", covers[3]);
        albumList.add(a);

        a = new DMData("SDM List", covers[4]);
        albumList.add(a);
